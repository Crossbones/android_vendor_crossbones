...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=yakju BUILD_DISPLAY_ID=JWR66V BUILD_FINGERPRINT="google/yakju/maguro:4.3/JWR66V/573038:user/release-keys" PRIVATE_BUILD_DESC="yakju-user 4.3 JWR66V 573038 release-keys"
