...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=mysidspr BUILD_DISPLAY_ID=JWR66V BUILD_FINGERPRINT="samsung/mysidspr/toroplus:4.3/JWR66V/573038:user/release-keys" PRIVATE_BUILD_DESC="mysidspr-user 4.3 JWR66V 573038 release-keys"
