...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=mysid BUILD_DISPLAY_ID=JWR66V BUILD_FINGERPRINT="google/mysid/toro:4.3/JWR66V/573038:user/release-keys" PRIVATE_BUILD_DESC="mysid-user 4.3 JWR66V 573038 release-keys"
